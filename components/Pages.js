...
export const page1 = () => {
    return(
        <SafeAreaView style={{...Shared.container}}>
            ...
            <Button title='Try the Door' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage1a}/>
            <Button title='Try the Window' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage1b}/>
        </SafeAreaView>
    )
}
...
export const page1a = () => {
    return(
        ...
        <Button title='Try to kick the door down' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage2}/>
        <Button title='Go Back' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage1}/>
        </SafeAreaView>
    )
}
...
export const page1b = () => {
    return(
        ...
        <Button title='Jump out the window' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage3}/>
        <Button title='Go Back' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage1}/>
        </SafeAreaView>
    )
}
...
export const page2 = () => {
    return(
        <SafeAreaView style={{...Shared.container}}>
            ...
            <Button title='Exit the Room' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage2a}/>
        </SafeAreaView>
    )
}
...
export const page2a = () => {
    return(
        <SafeAreaView style={{...Shared.container}}>
            ...
            <Button title='Go to the Right' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage2b}/>
            <Button title='Go to the Left' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage2c}/>
        </SafeAreaView>
    )
}
export const page2b =() => {
    return(
        <SafeAreaView style = {{...Shared.container}}>
            ...
            <Button title='Go back to the fork in the hallway' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage2a}/>
            <Button title='Go Down the Dark Stairwell' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage5}/>
        </SafeAreaView>
    )
}
export const page2c =() => {
    return(
        <SafeAreaView style = {{...Shared.container}}>
            ...
            <Button title='Go back to the fork in the hallway' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage2a}/>
            <Button title='Go Towards the Voices' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage8}/>
        </SafeAreaView>
    )
}
...
export const page3 = () => {
    return(
        <SafeAreaView style={{...Shared.container}}>
            ...
            <Button title='Try to pull the rod out of your foot' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage12}/>
            <Button title='Try to pull yourself out of the dumpster' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage4}/>
        </SafeAreaView>
    )
}
...
export const page4 = () => {
    return(
        <SafeAreaView style={{...Shared.container}}>
            ...
            <Button title='Continue' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage4a}/>
        </SafeAreaView>
    )
}
...
export const page4a = () => {
    return(
        <SafeAreaView style={{...Shared.container}}>
            ...
            <Button title='Try Again' style={[{...Shared.text}, {...Shared.button}]} onPress={goToMenu}/>
        </SafeAreaView>
    )
}
...
export const page5 = () => {
    return(
        <SafeAreaView style={{...Shared.container}}>
            ...
            <Button title='Open the Metal Door' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage6}/>
            <Button title='Open the Wooden Door' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage14}/>
            <Button title='Go Back' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage4}/>
...
export const page6 = () => {
    return(
        <SafeAreaView style={{...Shared.container}}>
            ...
            <Button title='Leave the Room' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage6a}/>
            <Button title='Examine the work bench' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage6b}/>
        </SafeAreaView>
    )
}
export const page6a = () => {
    return(
        <SafeAreaView style={{...Shared.container}}>
            ...
            <Button title='Open the metal door' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage6}/>
            <Button title='Open the wooden door' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage14}/>
            <Button title='Go Back up the Stairs' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage2a}/>
        </SafeAreaView>
    )
}
...
export const page6b = () => {
    return(
        <SafeAreaView style={{...Shared.container}}>
            ...
            <Button title='Leave the room' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage6a}/>
            <Button title='Look at the papers' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage7}/>
        </SafeAreaView>
    )
}
...
export const page7 = () => {
    return(
        <SafeAreaView style={{...Shared.container}}>
            ...
            <Button title='Hide in the lab' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage13}/>
            <Button title='Continue down the hallway' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage14}/>
        </SafeAreaView>
    )
}
...
export const page8 = () => {
    return(
        <SafeAreaView style={{...Shared.container}}>
            ...
            <Button title='Get a closer look' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage8a}/>
            <Button title='Get out of here' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage2a}/>
        </SafeAreaView>
    )
}
...
export const page8a = () => {
    return(
        <SafeAreaView style={{...Shared.container}}>
            ...
            <Button title='Go back to the stairwell' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage2a}/>
            <Button title='Get closer to hear their conversation' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage9}/>
        </SafeAreaView>
    )
}
...
export const page9 = () => {
    return(
        <SafeAreaView style={{...Shared.container}}>
            ...
            <Button title='Try to sneak past the men' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage10}/>
            <Button title='Go back to the hallway' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage2a}/>
        </SafeAreaView>
    )
}
...
export const page10 = () => {
    return(
        <SafeAreaView style={{...Shared.container}}>
            ...
            <Button title='Wake up!' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage11}/>
        </SafeAreaView>
    )
}
...
export const page11 = () => {
    return(
        <SafeAreaView style={{...Shared.container}}>
            ...
            <Button title='Look at the door' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage11a}/>
        </SafeAreaView>
    )
}
...
export const page12 = () => {
    return(
        <SafeAreaView style={{...Shared.container}}>
            ...
            <Button title='Go through the door' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage2a}/>
        </SafeAreaView>
    )
}
...
export const page14 = () => {
    return(
        <SafeAreaView style={{...Shared.container}}>
            ...
            <Button title='Go down the tunnel' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage14a}/>
            <Button title='Leave the room' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage14b}/>
        </SafeAreaView>
    )
}
...
export const page14a = () => {
    return(
        <SafeAreaView style={{...Shared.container}}>
            ...
            <Button title='Go Left' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage15}/>
            <Button title='Go Right' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage18}/>
        </SafeAreaView>
    )
}
...
export const page15 = () => {
    return(
        <SafeAreaView style={{...Shared.container}}>
            ...
            <Button title='Cross to continue down the path' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage16}/>
            <Button title='Follow the stream' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage17}/>
        </SafeAreaView>
    )
}
...
export const page16 = () => {
    return(
        <SafeAreaView style={{...Shared.container}}>
            ...
            <Button title='Go to Page 11' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage11}/>
        </SafeAreaView>
    )
}
...
export const page17 = () => {
    return(
        <SafeAreaView style={{...Shared.container}}>
            ...
            <Button title='Approach her' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage17a}/>
        </SafeAreaView>
    )
}
...
export const page17a = () => {
    return(
        <SafeAreaView style={{...Shared.container}}>
            ...
            <Button title='...' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage17b}/>
        </SafeAreaView>
    )
}
...
export const page17b = () => {
    return(
        <SafeAreaView style={{...Shared.container}}>
            ...
            <Button title='The End' style={[{...Shared.text}, {...Shared.button}]} onPress={goToMenu}/>
        </SafeAreaView>
    )
}
...
export const page18 = () => {
    return(
        <SafeAreaView style={{...Shared.container}}>
            ...
            <Button title='Look around' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage18a}/>
            <Button title='Go Back' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage18b}/>
        </SafeAreaView>
    )
}
export const page18a = () => {
    return(
        <SafeAreaView style={{...Shared.container}}>
            ...
            <Button title='Climb up' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage19}/>
            <Button title='Go down into the cavern' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage20}/>
        </SafeAreaView>
    )
}
...
export const page19 = () => {
    return(
        <SafeAreaView style={{...Shared.container}}>
            ...
            <Button title='Get out of here' style={[{...Shared.text}, {...Shared.button}]} onPress={goToPage19a}/>
        </SafeAreaView>
    )
}
