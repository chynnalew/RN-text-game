...
import {page1, page1a, page1b, page2, page2a, page2b, page2c, page3, page4, page4a, page5, page6, page6a, page6b, page7, page8, page8a, page9, page10, page11, page11a, page12, page13, page14, page14a, page14b, page15, page16, page17, page17a, page17b, page18, page18a, page18b, page19, page19a, page20} from './Pages';
    ...
    return(
        <Router>
            <Scene key='root'>
                ...
                <Scene key='page1a' component={page1a} title="Page 1"/>
                <Scene key='page1b' component={page1b} title="Page 1"/>
                <Scene key='page2' component={page2} title="Page 2"/>
                <Scene key='page2a' component={page2a} title="Page 2"/>
                <Scene key='page2b' component={page2b} title="Page 2"/>
                <Scene key='page2c' component={page2c} title="Page 2"/>
                <Scene key='page3' component={page3} title="Page 3"/>
                <Scene key='page4' component={page4} title="Page 4"/>
                <Scene key='page4a' component={page4a} title="Page 4"/>
                ...
                <Scene key='page8a' component={page8a} title="Page 8"/>
                ...
                <Scene key='page11' component={page11a} title="Page 11"/>
                ...
                <Scene key='page17a' component={page17a} title="Page 17"/>
                <Scene key='page17b' component={page17b} title="Page 17"/>
                <Scene key='page18' component={page18} title="Page 18"/>
                <Scene key='page18a' component={page18a} title="Page 18"/>
                <Scene key='page18b' component={page18b} title="Page 18"/>
                <Scene key='page19' component={page19} title="Page 19"/>
                <Scene key='page19a' component={page19a} title="Page 19"/>
